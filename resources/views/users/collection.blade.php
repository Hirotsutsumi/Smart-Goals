...
<div class="row">
        <aside class="col-sm-4">
            ...
            {!! Form::submit('Change avatar (from the right list)', ['class' => 'btn btn-register btn-block hover', 'style' => 'font-weight:bold; font-size:large']) !!}
        </aside>
        <div class="kinoko-container col-sm-8">
              <h1 style="text-align:center">KINOKO COLLECTION</h1>
                ...
                <div class="container">
                  ...
                  <a href="{{ asset  ('images/devil.jpg') }}" data-lightbox="kinoko" data-title="あくまきのこ<br>Smart Goalを１５こ達成すると仲間になるよ">
                    ...
                    <input class="disabled_checkbox" type="checkbox" name="image" value = "images/devil.jpg" checked />
                  </a>
                  @else
                  ...
                  <a href="{{ asset  ('images/sue.jpg') }}" data-lightbox="kinoko" data-title="へなちょこきのこ<br>Smart Goalを1こKeepすると仲間になるよ">
                    ...
                    <input class="disabled_checkbox" type="checkbox" name="image" value = "images/sue.jpg" checked />
                  </a>
                  @else
